...
SRCDIR='./mod/'                 # library source directory
TESTSRCDIR='./src/fortran'      # unit test source directory
BINDIR='./src/bin/'             # build directory for unit tests
LIBDIR='./src/lib/'             # build directory for library
...
FCOMPILERFLAGS='-c -O2 -stand f08 -traceback'
